...
export default function LoginPage() {
  ...
  const [version, setVersion] = useState<'a' | 'b'>(() => window.innerWidth < 768 ? 'b' : 'a');
  ...
  useEffect(() => {
    ...
    const handler = (e: MediaQueryListEvent) => setVersion(e.matches ? 'b' : 'a');
        ...
        <div className="login-a-form" style={{
          ...
          <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', gap: 0 }}>
            ...
            <p style={{ marginTop: 12, fontSize: 12, color: 'rgba(255,255,255,0.45)', textAlign: 'center' }}>
              ¿No tienes cuenta?{' '}
              <span onClick={() => navigate(ROUTES.REGISTRO)} style={{ color: '#C8A84B', fontWeight: 700, cursor: 'pointer' }}>
                Regístrate
              </span>
            </p>
            <p style={{ marginTop: 8, fontSize: 9, color: 'rgba(255,255,255,0.2)', textAlign: 'center' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '8px 24px 16px', position: 'relative', zIndex: 1, minHeight: 0 }}>
        <div className="login-b-modal" style={{
          ...
          <div className="login-b-modal-inner" style={{ padding: '24px 36px 22px' }}>
            ...
            <p style={{ marginTop: 12, fontSize: 12, color: '#818EA3', textAlign: 'center' }}>
              ¿No tienes cuenta?{' '}
              <span onClick={() => navigate(ROUTES.REGISTRO)} style={{ color: '#8B1A1A', fontWeight: 700, cursor: 'pointer' }}>
                Regístrate
              </span>
            </p>
            <p style={{ marginTop: 8, fontSize: 10, color: '#C8D2E0', textAlign: 'center' }}>
